...
export const SalesScreen: React.FC<SalesScreenProps> = ({ navigation }) => {
  ...
  const [filterSaleOrigin, setFilterSaleOrigin] = useState<'ALL' | 'INDEPENDENT' | 'CASH_REGISTER'>(
    'ALL'
  );
  ...
  const loadSales = async (pageNum: number = 1, isRefresh: boolean = false) => {
    ...
    try {
      ...
      logger.info('📊 Ventas cargadas:', response.data.length, {
        ...
        firstDocumentNumber: response.data[0]?.documentNumber,
        firstCode: response.data[0]?.code,
      });
  ...
  const renderSaleCard = useCallback(
    (sale: any) => {
      const customerName =
        sale.customerName ||
        sale.customerSnapshot?.fullName ||
        sale.companySnapshot?.razonSocial ||
        'Sin cliente';
            ...
            <View style={styles.cardHeaderLeft}>
              <View style={styles.codeContainer}>
                ...
                <View style={styles.codeTextContainer}>
                  <Text
                    style={[styles.cardCode, isTablet && styles.cardCodeTablet]}
                    numberOfLines={1}
                  >
                    {sale.documentNumber || sale.code}
                  </Text>
                  {sale.documentNumber && (
                    <Text style={styles.cardCodeSecondary} numberOfLines={1}>
                      {sale.code}
                    </Text>
                  )}
                </View>
              ...
              <View style={styles.badges}>
                ...
                <View
                  style={[
                    styles.badge,
                    {
                      backgroundColor: isIndependent
                        ? theme.color.state.info.background
                ...
                >
                  <Ionicons
                    ...
                    size={12}
                    color={
                      isIndependent ? theme.color.state.info.text : theme.color.state.success.text
                    }
                  />
                  <Text
                    style={[
                ...
                {/* Estado */}
                <View
                  style={[styles.badge, { backgroundColor: getStatusColor(sale.status) + '15' }]}
                >
                  <View
                    style={[styles.badgeDot, { backgroundColor: getStatusColor(sale.status) }]}
                  />
  ...
  const renderFilterChip = (
    ...
    <TouchableOpacity
      style={[styles.filterChip, currentValue === value && styles.filterChipActive]}
      onPress={onPress}
      activeOpacity={0.7}
    >
      {icon && (
      ...
      <Text style={[styles.filterChipText, currentValue === value && styles.filterChipTextActive]}>
        {label}
      </Text>
    </TouchableOpacity>
  );
        ...
        >
          <View style={styles.headerTop}>
            <View style={styles.headerTitleContainer}>
              ...
              <Text style={styles.subtitle}>Gestión de ventas B2C y B2B</Text>
            </View>
          ...
          <View style={styles.searchContainer}>
            ...
            >
              <Ionicons
                ...
                size={20}
                color={
                  getActiveFiltersCount() > 0 ? theme.color.brand.onHeader : theme.color.text.muted
                }
              />
        ...
        <View style={styles.quickFiltersContainer}>
          ...
          >
            ...
            {renderFilterChip(
              ...
              'INDEPENDENT',
              filterSaleOrigin,
              () => setFilterSaleOrigin('INDEPENDENT'),
              'person-outline'
            )}
            {renderFilterChip(
              'De Caja',
              'CASH_REGISTER',
              filterSaleOrigin,
              () => setFilterSaleOrigin('CASH_REGISTER'),
              'cash-outline'
            )}
            <View style={styles.filterDivider} />
            {renderFilterChip('Pendiente', PaymentStatus.PENDING, filterPaymentStatus, () =>
              setFilterPaymentStatus(
                filterPaymentStatus === PaymentStatus.PENDING ? 'ALL' : PaymentStatus.PENDING
              )
            )}
            {renderFilterChip('Pagado', PaymentStatus.PAID, filterPaymentStatus, () =>
              setFilterPaymentStatus(
                filterPaymentStatus === PaymentStatus.PAID ? 'ALL' : PaymentStatus.PAID
              )
            )}
          </ScrollView>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptySubtext}>Crea una nueva venta para comenzar</Text>
                ...
                <View style={styles.filterSection}>
                  ...
                  <View style={styles.filterOptions}>
                    ...
                    {Object.values(SaleStatus).map((status) => (
                      ...
                      >
                        <View
                          style={[styles.filterDot, { backgroundColor: getStatusColor(status) }]}
                        />
                        <Text
                          style={[
                            styles.filterOptionText,
                ...
                <View style={styles.filterSection}>
                  ...
                  <View style={styles.filterOptions}>
                    <TouchableOpacity
                      style={[
                        styles.filterOption,
                        filterPaymentStatus === 'ALL' && styles.filterOptionActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.filterOptionText,
                          filterPaymentStatus === 'ALL' && styles.filterOptionTextActive,
                        ]}
                      >
                        Todos
                      </Text>
                    ...
                    {Object.values(PaymentStatus).map((status) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.filterOption,
                          filterPaymentStatus === status && styles.filterOptionActive,
                        ]}
                      ...
                      >
                        ...
                        <Text
                          style={[
                            styles.filterOptionText,
                            filterPaymentStatus === status && styles.filterOptionTextActive,
                          ]}
                        >
                ...
                <View style={styles.filterSection}>
                  ...
                  <View style={styles.filterOptions}>
                    <TouchableOpacity
                      style={[
                        styles.filterOption,
                        filterSaleOrigin === 'ALL' && styles.filterOptionActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.filterOptionText,
                          filterSaleOrigin === 'ALL' && styles.filterOptionTextActive,
                        ]}
                      >
                        Todas
                      </Text>
                    ...
                    <TouchableOpacity
                      style={[
                        styles.filterOption,
                        filterSaleOrigin === 'INDEPENDENT' && styles.filterOptionActive,
                      ]}
                    ...
                    >
                      ...
                      <Text
                        style={[
                          styles.filterOptionText,
                          filterSaleOrigin === 'INDEPENDENT' && styles.filterOptionTextActive,
                        ]}
                      >
                        Independientes
                      </Text>
                    ...
                    <TouchableOpacity
                      style={[
                        styles.filterOption,
                        filterSaleOrigin === 'CASH_REGISTER' && styles.filterOptionActive,
                      ]}
                    ...
                    >
                      <Ionicons
                        ...
                        size={16}
                        color={
                          filterSaleOrigin === 'CASH_REGISTER'
                            ? theme.color.text.inverse
                            : theme.color.text.muted
                        }
                      />
                      <Text
                        style={[
                          styles.filterOptionText,
                          filterSaleOrigin === 'CASH_REGISTER' && styles.filterOptionTextActive,
                        ]}
                      >
                        De Caja
                      </Text>
