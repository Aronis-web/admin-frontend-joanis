...
export const ProductsScreen: React.FC<ProductsScreenProps> = ({ navigation }) => {
  ...
  const [isVariantsModalVisible, setIsVariantsModalVisible] = useState(false);
  ...
  const handleManageCodes = (product: Product) => {
  ...
  const handleManageVariants = (product: Product) => {
    ...
    setIsVariantsModalVisible(true);
  };
        ...
        <Card variant="outlined" padding="none" style={styles.productCard}>
          ...
          >
                ...
                <View style={styles.productMetaRow}>
                  {product.correlativeNumber && (
                    <Text
                      ...
                      style={styles.productCorrelative}
                    >
                      #{product.correlativeNumber}
                    </Text>
                  )}
                  ...
                  {hasDuplicateSKU(product.sku) && (
                    <View style={styles.duplicateBadge}>
                      <Text variant="labelSmall" color={theme.color.text.warning}>
                        ⚠️ Duplicado
                      </Text>
                    </View>
                  )}
              ...
              <View style={styles.badgesContainer}>
                ...
                {!hasImage && (
                  <View style={styles.noPhotoBadge}>
                    <Text variant="labelSmall" color={theme.color.text.danger}>
                      📷 Sin foto
                    </Text>
                  </View>
                )}
            ...
            <View style={styles.productFooter}>
              ...
              <Text variant="titleLarge" color={theme.color.text.placeholder}>
                ›
              </Text>
            </View>
          </TouchableOpacity>
          ...
          <View style={styles.productActions}>
            ...
            >
              <Text variant="labelMedium" color={theme.color.text.warning}>
                📸 Fotos
              </Text>
            </TouchableOpacity>
            ...
            <ProtectedTouchableOpacity
              ...
              onPress={() => handleManageCodes(product)}
              requiredPermissions={[PERMISSIONS.PRODUCTS.CODES_READ]}
              hideIfNoPermission={true}
            >
              <Text variant="labelMedium" color={theme.color.text.link}>
                🏷️ Códigos
              </Text>
            </ProtectedTouchableOpacity>
            ...
            <ProtectedTouchableOpacity
              style={styles.actionButton}
              onPress={() => handleManageVariants(product)}
              requiredPermissions={[PERMISSIONS.PRODUCTS.VARIANTS_READ]}
              hideIfNoPermission={true}
            >
              <Text variant="labelMedium" color={theme.color.text.link}>
                🎨 Variantes
            ...
            <ProtectedTouchableOpacity
              ...
              hideIfNoPermission={true}
            >
              <Text variant="labelMedium" color={theme.color.text.muted}>
                ✏️ Editar
              </Text>
            </ProtectedTouchableOpacity>
  ...
  return (
    <ScreenLayout navigation={navigation}>
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        {duplicateSKUs.length > 0 && (
          <View style={styles.warningBanner}>
            ...
            <View style={styles.warningContent}>
              <Text variant="titleSmall" color={theme.color.text.warning}>
        ...
        {/* Product Codes Modal */}
        <ProductCodesModal
          visible={isCodesModalVisible}
          onClose={() => setIsCodesModalVisible(false)}
          product={selectedProductForCodes}
        />

        {/* Product Variants Modal */}
        <ProductVariantsModal
          visible={isVariantsModalVisible}
          onClose={() => setIsVariantsModalVisible(false)}
              ...
              <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
                  ...
                  <View style={styles.viewRow}>
                    ...
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            STATUS_CONFIG[viewProduct.status]?.color || theme.color.icon.subtle,
                        },
                      ]}
                    >
                      <Text variant="labelSmall" color={theme.color.text.inverse}>
                        {STATUS_CONFIG[viewProduct.status]?.label}
                      </Text>
                    </View>
                  </View>
                </Card>
                ...
                <Card variant="outlined" style={styles.viewSection}>
                  ...
                  <View style={styles.viewRow}>
                    ...
                    <Text variant="bodyMedium" color="primary">
                      {viewProduct.currency || 'PEN'}
                    </Text>
                  </View>
                  {viewProduct.weightKg !== undefined &&
                    viewProduct.weightKg !== null &&
                    typeof viewProduct.weightKg === 'number' &&
                    !isNaN(viewProduct.weightKg) && (
                      <View style={styles.viewRow}>
                  ...
                  <Card variant="outlined" style={styles.viewSection}>
                    ...
                    {viewProduct.presentations.map((pres, index) => (
                      <View key={index} style={styles.presentationCard}>
                        ...
                        <Caption color="tertiary">
                          Factor: {pres.factorToBase} | Min: {pres.minOrderQty}
                        </Caption>
                      </View>
                    ))}
                  </Card>
