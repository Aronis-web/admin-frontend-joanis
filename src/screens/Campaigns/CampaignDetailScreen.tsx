...
export const CampaignDetailScreen: React.FC<CampaignDetailScreenProps> = ({
  ...
  // Memoize the rendered products list to improve performance
            ...
            <View style={styles.listItemContent}>
              <View style={styles.productTitleRow}>
                <Text style={styles.productTitle} numberOfLines={2}>
                  {productDetails?.title || 'Producto sin título'}
                </Text>
                {isPreliminary && (
                  <View style={styles.preliminaryBadge}>
                    <Text style={styles.preliminaryBadgeText}>⚠️ Preliminar</Text>
                  </View>
                )}
              </View>
              <Text style={styles.productSku}>SKU: {productDetails?.sku || 'N/A'}</Text>
              <Text style={styles.productQuantity}>
                Cantidad: {product.totalQuantityBase} {productDetails?.baseUnit || 'unidades'}
              </Text>

              {product.distributionGenerated && (
                <View style={styles.distributionBadge}>
                  <Text style={styles.distributionBadgeText}>✓ Distribución generada</Text>
                </View>
              )}

              {product.bannerUrl && (
                <View style={styles.bannerBadge}>
                  <Text style={styles.bannerBadgeText}>🖼️ Banner configurado</Text>
                </View>
              )}
            </View>
              ...
              <View style={styles.actionsRow}>
                ...
                >
                  <Text style={styles.actionButtonText}>
                    {product.bannerUrl ? '🖼️ Ver/Editar Banner' : '🖼️ Agregar Banner'}
                  </Text>
                </TouchableOpacity>

                <ProtectedElement requiredPermissions={[PERMISSIONS.CAMPAIGNS.DELETE_PRODUCT]}>
                  <TouchableOpacity
                ...
                {editingCost?.productId === product.productId ? (
                  <View style={styles.priceEditRow}>
                    ...
                    <TextInput
                      ...
                      onChangeText={(value) => setEditingCost({ ...editingCost, value })}
                    ...
                    >
                      <Text style={styles.saveButtonText}>{savingPrice ? '⏳' : '✓'}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
